##
## Action functions helper module
##
...
Export-ModuleMember -Function Set-ActionVariable, Add-ActionSecretMask, Add-ActionPath, Get-ActionInput,
    Get-ActionInputs, Set-ActionOutput, Set-ActionFailed, Write-ActionDebug, Write-ActionError,
    Write-ActionWarning, Write-ActionInfo, Enter-ActionOutputGroup, Exit-ActionOutputGroup,
